...
class BookstoreRepository extends StateNotifier<List<Book>> {
  BookstoreRepository(Ref ref) : super(ref.watch(initialBooks));
...
class CategoryRepository extends StateNotifier<List<BookCategory>> {
  CategoryRepository(Ref ref) : super(ref.watch(initalBookCategories));
...
final initialBooks = Provider<List<Book>>((_) => [
...
final initalBookCategories = Provider<List<BookCategory>>((_) => [sciFi, fantasy]);

final categoryProvider =
    StateNotifierProvider<CategoryRepository, List<BookCategory>>((ref) => CategoryRepository(ref));
final bookstoreRepositoryProvider =
    StateNotifierProvider<BookstoreRepository, List<Book>>((ref) => BookstoreRepository(ref));
